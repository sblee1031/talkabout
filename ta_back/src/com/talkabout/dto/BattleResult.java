...
public BattleResult(String member_no, String deb_like, String deb_no, String com_writer, String com_contents,
...
public BattleResult(String member_no, String discuss_time, String discuss_start_date, String discuss_topic) {
	super();
	this.member_no = member_no;
	this.discuss_time = discuss_time;
	this.discuss_start_date = discuss_start_date;
