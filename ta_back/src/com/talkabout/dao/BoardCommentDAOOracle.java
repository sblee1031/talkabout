...
//		int Board_no = 1;
//		int com_mem = 1;
//		list = dao.myBoardComSearch(Board_no, com_mem);
//		for(BoardComment boardComment : list) {
//			System.out.print(boardComment.getCom_no() + " ");
//			System.out.print(boardComment.getCom_board()+ " ");
//			System.out.print(boardComment.getCom_date()+ " ");
//			System.out.print(boardComment.getCom_contents()+ " ");
//			System.out.print(boardComment.getCom_mem() + "//	");
//	
//		}
